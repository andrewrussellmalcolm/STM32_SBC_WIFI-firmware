...
C_SRCS += \
../Core/Src/tasks/lora_task.c \
../Core/Src/tasks/main_task.c \
../Core/Src/tasks/wifi_task.c 

OBJS += \
./Core/Src/tasks/lora_task.o \
./Core/Src/tasks/main_task.o \
./Core/Src/tasks/wifi_task.o 

C_DEPS += \
./Core/Src/tasks/lora_task.d \
./Core/Src/tasks/main_task.d \
...
clean-Core-2f-Src-2f-tasks:
	-$(RM) ./Core/Src/tasks/lora_task.cyclo ./Core/Src/tasks/lora_task.d ./Core/Src/tasks/lora_task.o ./Core/Src/tasks/lora_task.su ./Core/Src/tasks/main_task.cyclo ./Core/Src/tasks/main_task.d ./Core/Src/tasks/main_task.o ./Core/Src/tasks/main_task.su ./Core/Src/tasks/wifi_task.cyclo ./Core/Src/tasks/wifi_task.d ./Core/Src/tasks/wifi_task.o ./Core/Src/tasks/wifi_task.su
